...
export const translations = {
  he: {
    ...
    arvitKidushLevana: 'ערבית וקידוש לבנה',
    shiurNote: (topic) => `שיעור מאת הרב נתנאל ב${topic} לאחר התפילה`,
    shiurNoteNoRav: (topic) => `שיעור ב${topic} לאחר התפילה`,
    halachaBtn: 'הלכה לשבת',
    print: '🖨️ הדפס / שמור כ-PDF',
    share: '📤 שיתוף',
    footer: 'שבת שלום!',
    footerChag: 'שנה טובה וכתיבה וחתימה טובה!',
    footerYK: 'גמר חתימה טובה!',
    festivalShabbatTitle: (he) => `שבת קודש · ${he}`,
    footerChagShabbat: 'שבת שלום וחג שמח!',
    footerMoedShabbat: 'שבת שלום ומועדים לשמחה!',
    ykMainTitle: (yearHe) => `יום הכיפורים ${yearHe}`,
    cdBeforeYK: 'יום הכיפורים נכנס בעוד',
    cdDuringYK: 'גמר חתימה טובה! צאת הצום בעוד',
    error: 'שגיאה בטעינת נתונים',
    cdBefore: 'שבת נכנסת בעוד',
    cdBeforeChag: 'החג נכנס בעוד',
    cdDuringChag: 'שנה טובה! צאת החג בעוד',
    ...
    fastEndKidushLevana: 'ערבית וסיום הצום, קידוש לבנה',
    fastEndHavdalahKidushLevana: 'ערבית וסיום הצום, הבדלה על הכוס וקידוש לבנה',
    fastDawnStart: 'עלות השחר ותחילת הצום',
    ykErevSection: (wd) => (wd === 'שבת' ? 'ערב יום כיפור · שבת' : `ערב יום כיפור · יום ${wd}`),
    ykDaySection: (wd) => (wd === 'שבת' ? 'יום כיפור · שבת' : `יום כיפור · יום ${wd}`),
    ykSelichot: 'סליחות ושחרית',
    ykMinchaGedola: 'מנחה גדולה',
    ykCandles: 'הדלקת נרות',
    ykTefilaZaka: 'תפילה זכה',
    ykKolNidrei: 'כל נדרי וערבית',
    ykShacharit: 'שחרית ומוסף',
    ykMincha: 'מנחה',
    ykNeila: 'נעילה (משוער)',
    ykArvitKidushLevana: 'ערבית וקידוש לבנה',
    ykFastEnd: 'צאת הצום',
    // ── ראש השנה ─────────────────────────────────────────────
    rhMainTitle: (yearHe) => `ראש השנה ${yearHe}`,
    rhChagEndShort: 'צאת החג',
    rhErevSection: (wd) => (wd === 'שבת' ? 'ערב ראש השנה · שבת' : `ערב ראש השנה · יום ${wd}`),
    rhDay1Section: (wd) => (wd === 'שבת' ? 'יום א׳ של ראש השנה · שבת' : `יום א׳ של ראש השנה · יום ${wd}`),
    rhDay2Section: (wd) => (wd === 'שבת' ? 'יום ב׳ של ראש השנה · שבת' : `יום ב׳ של ראש השנה · יום ${wd}`),
    rhCandles: 'הדלקת נרות יו״ט',
    rhCandlesShabbat: 'הדלקת נרות שבת ויו״ט',
    rhMinchaErev: 'מנחה',
    rhMinchaErevShabbat: 'מנחה, קבלת שבת וערבית של יו״ט',
    rhDrasha: 'דרשה של הרב',
    rhArvitYT: 'ערבית של יום טוב',
    fastSelichotChabad: 'סליחות ושחרית באוהל חב״ד',
    rhSelichot: 'סליחות ושחרית',
    rhShacharit: 'שחרית',
    rhKiddush: 'קידוש (משוער)',
    rhTalkBeforeShofar: 'שיחה לפני התקיעות',
    rhShofar: 'תקיעת שופר (משוער)',
    rhShofarExtra: 'תקיעות נוספות לאחר התפילה',
    rhKiddushNoShofar: 'קידוש (משוער) — אין תוקעים בשופר בשבת',
    rhMincha: 'תפילת מנחה',
    rhTashlich: 'תשליך',
    rhShiur: 'שיעור',
    rhArvitYT2: 'ערבית של יום טוב',
    rhCandles2: 'הדלקת נרות יו״ט (מאש קיימת, לאחר צאת הכוכבים)',
    rhShiurDay: 'שיעור בענייני היום',
    rhArvitMotzaei: 'ערבית של צאת החג',
    rhChagEnd: 'צאת החג',
  ...
  en: {
    ...
    arvitKidushLevana: 'Arvit & Kiddush Levana',
    shiurNote: (topic) => `Shiur by Rav Netanel (${topic}) after services`,
    shiurNoteNoRav: (topic) => `Shiur (${topic}) after services`,
    halachaBtn: 'Halacha for Shabbat',
    print: '🖨️ Print / Save as PDF',
    share: '📤 Share',
    footer: 'Shabbat Shalom!',
    footerChag: 'Shana Tova — a good and sweet year!',
    footerYK: 'Gmar Chatima Tova!',
    festivalShabbatTitle: (he, en) => `Shabbat · ${en}`,
    footerChagShabbat: 'Shabbat Shalom & Chag Sameach!',
    footerMoedShabbat: 'Shabbat Shalom & Moadim LeSimcha!',
    ykMainTitle: (yearHe, yearNum) => `Yom Kippur ${yearNum}`,
    cdBeforeYK: 'Yom Kippur begins in',
    cdDuringYK: 'Gmar Chatima Tova! The fast ends in',
    error: 'Error loading data',
    cdBefore: 'Shabbat begins in',
    cdBeforeChag: 'The chag begins in',
    cdDuringChag: 'Shana Tova! The chag ends in',
    ...
    fastEndKidushLevana: 'Arvit — fast ends, Kiddush Levana',
    fastEndHavdalahKidushLevana: 'Arvit — fast ends, Havdalah & Kiddush Levana',
    fastDawnStart: 'Dawn — fast begins',
    ykErevSection: (wd) => `Erev Yom Kippur · ${wd}`,
    ykDaySection: (wd) => `Yom Kippur · ${wd}`,
    ykSelichot: 'Selichot & Shacharit',
    ykMinchaGedola: 'Mincha Gedola',
    ykCandles: 'Candle lighting',
    ykTefilaZaka: 'Tefilla Zaka',
    ykKolNidrei: 'Kol Nidrei & Arvit',
    ykShacharit: 'Shacharit & Musaf',
    ykMincha: 'Mincha',
    ykNeila: 'Neila (approx.)',
    ykArvitKidushLevana: 'Arvit & Kiddush Levana',
    ykFastEnd: 'Fast ends',
    // ── Rosh Hashana ─────────────────────────────────────────
    rhMainTitle: (yearHe, yearNum) => `Rosh Hashana ${yearNum}`,
    rhChagEndShort: 'Chag ends',
    rhErevSection: (wd) => `Erev Rosh Hashana · ${wd}`,
    rhDay1Section: (wd) => `Rosh Hashana, day 1 · ${wd}`,
    rhDay2Section: (wd) => `Rosh Hashana, day 2 · ${wd}`,
    rhCandles: 'Yom Tov candle lighting',
    rhCandlesShabbat: 'Shabbat & Yom Tov candle lighting',
    rhMinchaErev: 'Mincha',
    rhMinchaErevShabbat: 'Mincha, Kabbalat Shabbat & Yom Tov Arvit',
    rhDrasha: "The Rav's drasha",
    rhArvitYT: 'Yom Tov Arvit',
    fastSelichotChabad: 'Selichot & Shacharit at the Chabad tent',
    rhSelichot: 'Selichot & Shacharit',
    rhShacharit: 'Shacharit',
    rhKiddush: 'Kiddush (approx.)',
    rhTalkBeforeShofar: 'Talk before the shofar blowing',
    rhShofar: 'Shofar blowing (approx.)',
    rhShofarExtra: 'Further blowings after the service',
    rhKiddushNoShofar: 'Kiddush (approx.) — the shofar is not blown on Shabbat',
    rhMincha: 'Mincha',
    rhTashlich: 'Tashlich',
    rhShiur: 'Shiur',
    rhArvitYT2: 'Yom Tov Arvit',
    rhCandles2: 'Yom Tov candle lighting (from an existing flame, after nightfall)',
    rhShiurDay: 'Shiur on the themes of the day',
    rhArvitMotzaei: 'Arvit at the close of the chag',
    rhChagEnd: 'Chag ends',
  ...
  fr: {
    ...
    arvitKidushLevana: 'Arvit et Kiddouch Levana',
    shiurNote: (topic) => `Cours du Rav Netanel (${topic}) après l'office`,
    shiurNoteNoRav: (topic) => `Cours (${topic}) après l'office`,
    halachaBtn: 'Halakha pour Chabbat',
    print: '🖨️ Imprimer / Enregistrer en PDF',
    share: '📤 Partager',
    footer: 'Chabbat Chalom !',
    footerChag: 'Chana Tova — bonne et douce année !',
    footerYK: 'Gmar Hatima Tova !',
    festivalShabbatTitle: (he, en, fr) => `Chabbat · ${fr}`,
    footerChagShabbat: 'Chabbat Chalom et Hag Saméah !',
    footerMoedShabbat: 'Chabbat Chalom et Moadim Lesimha !',
    ykMainTitle: (yearHe, yearNum) => `Yom Kippour ${yearNum}`,
    cdBeforeYK: 'Yom Kippour commence dans',
    cdDuringYK: 'Gmar Hatima Tova ! Fin du jeûne dans',
    error: 'Erreur de chargement des données',
    cdBefore: 'Le Chabbat commence dans',
    cdBeforeChag: 'La fête commence dans',
    cdDuringChag: 'Chana Tova ! Fin de la fête dans',
    ...
    fastEndKidushLevana: 'Arvit — fin du jeûne, Kiddouch Levana',
    fastEndHavdalahKidushLevana: 'Arvit — fin du jeûne, Havdala et Kiddouch Levana',
    fastDawnStart: 'Aube — début du jeûne',
    ykErevSection: (wd) => `Veille de Yom Kippour · ${wd}`,
    ykDaySection: (wd) => `Yom Kippour · ${wd}`,
    ykSelichot: "Selihot et Cha'harit",
    ykMinchaGedola: "Min'ha Guedola",
    ykCandles: 'Allumage des bougies',
    ykTefilaZaka: 'Tefila Zaka',
    ykKolNidrei: 'Kol Nidré et Arvit',
    ykShacharit: "Cha'harit et Moussaf",
    ykMincha: "Min'ha",
    ykNeila: 'Neïla (approx.)',
    ykArvitKidushLevana: 'Arvit et Kiddouch Levana',
    ykFastEnd: 'Fin du jeûne',
    // ── Roch Hachana ─────────────────────────────────────────
    rhMainTitle: (yearHe, yearNum) => `Roch Hachana ${yearNum}`,
    rhChagEndShort: 'Sortie de la fête',
    rhErevSection: (wd) => `Veille de Roch Hachana · ${wd}`,
    rhDay1Section: (wd) => `Roch Hachana, 1er jour · ${wd}`,
    rhDay2Section: (wd) => `Roch Hachana, 2e jour · ${wd}`,
    rhCandles: 'Allumage des bougies de Yom Tov',
    rhCandlesShabbat: 'Allumage des bougies de Chabbat et Yom Tov',
    rhMinchaErev: "Min'ha",
    rhMinchaErevShabbat: "Min'ha, Kabbalat Chabbat et Arvit de Yom Tov",
    rhDrasha: 'Dracha du Rav',
    rhArvitYT: 'Arvit de Yom Tov',
    fastSelichotChabad: "Seli'hot et Cha'harit sous la tente Habad",
    rhSelichot: "Seli'hot et Cha'harit",
    rhShacharit: "Cha'harit",
    rhKiddush: 'Kiddouch (approx.)',
    rhTalkBeforeShofar: 'Causerie avant la sonnerie du chofar',
    rhShofar: 'Sonnerie du chofar (approx.)',
    rhShofarExtra: "Sonneries supplémentaires après l'office",
    rhKiddushNoShofar: "Kiddouch (approx.) — on ne sonne pas du chofar le Chabbat",
    rhMincha: "Min'ha",
    rhTashlich: 'Tachlich',
    rhShiur: 'Cours',
    rhArvitYT2: 'Arvit de Yom Tov',
    rhCandles2: "Allumage des bougies de Yom Tov (à partir d'une flamme existante, après la tombée de la nuit)",
    rhShiurDay: 'Cours sur les thèmes du jour',
    rhArvitMotzaei: 'Arvit de sortie de la fête',
    rhChagEnd: 'Sortie de la fête',

...
export const translations = {
  he: {
    ...
    printInclude: (name) => `להדפיס גם את ${name}`,
    share: '📤 שיתוף',
    footer: 'שבת שלום!',
    ...
    ykTefilaZaka: 'לפני כל נדרי — אמירת "תפילה זכה"',
  ...
  en: {
    ...
    printInclude: (name) => `Include ${name} in the print`,
    share: '📤 Share',
    ...
    ykTefilaZaka: 'Before Kol Nidrei — recite "Tefilla Zaka"',
  ...
  fr: {
    ...
    printInclude: (name) => `Inclure ${name} à l'impression`,
    share: '📤 Partager',
    ...
    ykTefilaZaka: 'Avant Kol Nidré — récitation de « Tefila Zaka »',

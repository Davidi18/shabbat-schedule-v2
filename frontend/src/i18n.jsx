...
export const translations = {
  he: {
    ...
    rhKiddushNoShofar: 'קידוש (אין תוקעים בשופר בשבת)',
    rhMincha: 'תפילת מנחה',
    rhTashlich: 'תשליך',
    rhShiur: 'שיעור',
  ...
  en: {
    ...
    rhKiddushNoShofar: 'Kiddush (the shofar is not blown on Shabbat)',
    rhMincha: 'Mincha',
    rhTashlich: 'Tashlich',
    rhShiur: 'Shiur',
  ...
  fr: {
    ...
    rhKiddushNoShofar: "Kiddouch (on ne sonne pas du chofar le Chabbat)",
    rhMincha: "Min'ha",
    rhTashlich: 'Tachlich',
    rhShiur: 'Cours',

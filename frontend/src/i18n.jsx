...
export const translations = {
  he: {
    ...
    rhNoShofarShabbat: 'אין תוקעים בשופר בשבת — התקיעות ביום ב׳ של ראש השנה',
    rhMincha: 'תפילת מנחה',
    rhTashlich: 'תשליך',
    rhShiur: 'שיעור',
  ...
  en: {
    ...
    rhNoShofarShabbat: 'The shofar is not blown on Shabbat — the blowings are on the second day',
    rhMincha: 'Mincha',
    rhTashlich: 'Tashlich',
    rhShiur: 'Shiur',
  ...
  fr: {
    ...
    rhNoShofarShabbat: 'On ne sonne pas du chofar le Chabbat — les sonneries ont lieu le 2e jour',
    rhMincha: "Min'ha",
    rhTashlich: 'Tachlich',
    rhShiur: 'Cours',
